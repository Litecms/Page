...
<div class="app-item">
    ...
    <div class="app-actions">
        <a href="{!!guard_url('page/page')!!}/{!!$value['id']!!}" class="btn fas fa-pencil-alt" data-action='EDIT'
            data-load-to="#app-entry" data-url="{!!guard_url('page/page')!!}/{!!$value['id']!!}/edit"></a>
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                ...
                <a class="dropdown-item" href="{!!guard_url('page/page')!!}/{!!$value['id']!!}" 
