<div class="app-entry-form-wrap">
    <div class="app-sec-title app-sec-title-with-icon app-sec-title-with-action">
        ...
        <div class="actions">
            <button type="button" class="btn btn-with-icon btn-link  btn-outline" data-action='EDIT'
                data-load-to="#app-entry" data-url="{{guard_url('page/page')}}/{!!$data->getRouteKey()!!}/edit"><i
            ...
            <button type="button" class="btn btn-with-icon btn-link  btn-outline" data-action='DELETE'
                ...
                data-url="{{guard_url('page/page')}}/{!!$data->getRouteKey()!!}"><i
    ...
    ->class('app-form-show')
    ->method('PUT')
    ->action(guard_url('page/page/'. $data->getRouteKey()))!!}
