...
<div class="app-item">
    <div class="app-info" data-action='SHOW' data-load-to="#app-entry"
        data-url="{{guard_url('page/page')}}/{{$value['id']}}">
    ...
    <div class="app-actions">
        <a href="{{guard_url('page/page')}}/{{$value['id']}}" class="btn las la-pencil-alt" data-action='EDIT'
            data-load-to="#app-entry" data-url="{{guard_url('page/page')}}/{{$value['id']}}/edit">
        </a>
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="app_quick_menu_{{$value['id']}}">
                ...
                <a class="dropdown-item" href="{{guard_url('page/page')}}/{!!$value['id']!!}" data-action='DELETE'
                data-load-to="#app-entry" data-list="#item-list"
                data-url="{{guard_url('page/page')}}/{!!$value['id']!!}"><i class="las la-times text-danger"></i>Delete</a>
            </div>
        </div>
    </div>
</div>
